...
If you do not want to build it manually, just download the [latest jar](https://github.com/quantifind/KafkaOffsetMonitor/releases/latest). If you do want to build it, note that JDK 8 is recommended, because sbt has been observed to fail under JDK 9.
